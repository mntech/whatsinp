...
<<<<<<< HEAD
                	preg_match('/^http/', $file, $matches);Mage::log('My log entry');
   			...
   			if (!empty($matches)) { 
				...
				$arrayToMassAdd[] = array('file' => trim(DS.$filename), 'mediaAttribute' => $mediaAttributeCode);
				Mage::log('My log message: '.$filename);
                	} else {
...
=======
   			...
   			if (!empty($matches)) { 
				...
				$arrayToMassAdd[] = array('file' => trim($filepath), 'mediaAttribute' => $mediaAttributeCode);
                		...
                		// below is original OOB code
                    		$arrayToMassAdd[] = array('file' => trim($file), 'mediaAttribute' => $mediaAttributeCode);
>>>>>>> ba5811dbd0cfe35da37ef30bf51766f4f1ea3314
                	}
