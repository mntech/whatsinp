                    ...
                    if (!$cart->getQuote()->getHasError()){
                       ...
                       // $this->_getSession()->addSuccess($message);
                        ...
                        if ($this->getLayout()->getBlock('cart_sidebar_mini')) {
						  ...
						  if ($this->getLayout()->getBlock('cart_sidebar_mini_mobile')) {
                            $mini_cart_mobile = $this->getLayout()->getBlock('cart_sidebar_mini_mobile')->toHtml();
                        }
						...
						$ajaxData['mini_cart_mobile'] = $mini_cart_mobile;
